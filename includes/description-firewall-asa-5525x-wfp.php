    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="title-border">Dispositivo Cisco ASA 5525-X con servicios FirePOWER</h3>
		              	...
		              	<div class="panel panel-default">
			                <div class="panel-heading">
				                <h4 class="panel-title"> 
				                	<a data-toggle="collapse" data-parent="#accordionA, #accordionB, #accordionC,
                                     #accordionD, #accordionE, #accordionF, #accordionG, #accordionH, #accordionI, #accordionH" href="#collapseOne">Cisco ASA 5525-X with FirePOWER Services</a> 
				                </h4>
			                </div>
			                <div id="collapseOne" class="panel-collapse collapse in">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    ...
                                    <p align='justify'><strong>Cisco ASA 5525-X with FirePOWER Services</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#ASA5525-FPWR-K9<br>
                                        <strong>Precio: $9,295.00</strong></p>
                                </div>
			                </div>
                            </div>
		              	</div><!--/ Panel 1 end-->
			                ...
			                <div id="collapseTwo" class="panel-collapse collapse">
			                  <div class="panel-body">
			                    <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                	...
                                	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Cisco ASA5525 FirePOWER IPS and Apps 1 Year Subscription</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#L-ASA5525-TA-1Y<br>
                                        <strong>Precio: $2,525.00</strong></p>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    <h3 class="title-border"></h3></div>

                                	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Cisco ASA5525 FirePOWER IPS and Apps 3 Year Subscription</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#L-ASA5525-TA-3Y<br>
                                        <strong>Precio: $6,060.00</strong></p>
                                </div>
			                  </div>
			                </div>
		              	</div><!--/ Panel 2 end-->
			                ...
			                <div id="collapseThree" class="panel-collapse collapse">
			                  <div class="panel-body">
			                    <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                	...
                                	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Cisco ASA5525 FirePOWER IPS, Apps and URL 1 Year Subscription</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#L-ASA5525-TAC-1Y<br>
                                        <strong>Precio: $4,020.00</strong></p>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    <h3 class="title-border"></h3></div>

                                	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Cisco ASA5525 FirePOWER IPS, Apps and URL 3 Year Subscription</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#L-ASA5525-TAC-3Y<br>
                                        <strong>Precio: $9,655.00</strong></p>
                                </div>
			                  </div>
			                </div>
		              	</div><!--/ Panel 3 end-->
			                ...
			                <div id="collapseFour" class="panel-collapse collapse">
			                  <div class="panel-body">
			                    <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                	...
                                	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Cisco ASA5525 FirePOWER IPS, Apps and AMP 1 Year Subscription</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#L-ASA5525-TAM-1Y<br>
                                        <strong>Precio: $4,295.00</strong></p>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    <h3 class="title-border"></h3></div>

                                	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Cisco ASA5525 FirePOWER IPS, Apps and AMP 3 Year Subscription</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#L-ASA5525-TAM-3Y<br>
                                        <strong>Precio: $10,300.00</strong></p>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    <h3 class="title-border"></h3></div>

                                	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Cisco ASA5525 FirePOWER IPS, Apps, AMP and URL 1 Year Subscription</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#L-ASA5525-TAMC-1Y<br>
                                        <strong>Precio: $6,170.00</strong></p>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    <h3 class="title-border"></h3></div>

                                	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Cisco ASA5525 FirePOWER IPS, Apps, AMP and URL 3 Year Subscription</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#L-ASA5525-TAMC-3Y<br>
                                        <strong>Precio: $14,805.00</strong></p>
                                </div>
			                  </div>
			                </div>
		              	</div><!--/ Panel 4 end-->
			                ...
			                <div id="collapseFive" class="panel-collapse collapse">
			                  <div class="panel-body">
			                    <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                	...
                                	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Cisco ASA5525 FirePOWER URL Filtering 1 Year Subscription</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#L-ASA5525-URL-1Y<br>
                                        <strong>Precio: $2,205.00</strong></p>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    <h3 class="title-border"></h3></div>

                                	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Cisco ASA5525 FirePOWER URL Filtering 3 Year Subscription</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#L-ASA5525-URL-3Y<br>
                                        <strong>Precio: $5,295.00</strong></p>
                                </div>
			                  </div>
			                </div>
		              	</div><!--/ Panel 5 end-->
                    ...
                    <div class="widget widget-tab">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab2">
                                ...
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                                        <tr>
                                            <th colspan="2" style="text-align: center">Cisco ASA 5525-X con servicios FirePOWER</th>
                                        </tr>
                                        <tr>
