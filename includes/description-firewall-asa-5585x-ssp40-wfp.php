    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="title-border">Dispositivo Cisco ASA 5585-X SSP-40 con servicios FirePOWER</h3>
                <h5>Firewall de próxima generación enfocado en amenazas (NGFW) diseñado para una nueva era de amenazas</h5>
                <center> <img class="img-responsive" src="images/firewalls-ngfw/cisco_asa_5585x_wfp.png" alt=""></center>
                    ...
                    <div class="widget widget-tab">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab2">
                                ...
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                                        <tr>
                                            <th colspan="2" style="text-align: center">Cisco ASA 5585-X SSP-40</th>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Interfaz de gestión y supervisión</td>
                                            <td>2 puertos Ethernet 10/100/1000</td>
                                        </tr>
                                    </table>
                            ...
                            <div class="tab-pane" id="tab5">
                                ...
                                <p align="justify">Los blades de hardware Cisco ASA 5585-X FirePOWER Services SSP-10, SSP-20, SSP-40 y SSP-60 son 
                                    compatibles con la plataforma Cisco ASA 5585-X. Los firewalls Cisco ASA 5585-X SSP-10, SSP-20, SSP-40 y SSP-60 
                                    requieren la versión 9.2.2 y posterior del software Cisco ASA. El software Cisco ASA con FirePOWER Services es 
                                    compatible con la serie Cisco ASA 5500-X de dispositivos de seguridad de rango medio de próxima generación que 
                                    ejecutan Cisco ASA Software Release 9.2.2 y posterior. Se requieren Cisco FireSIGHT Management Center y Cisco 
                                    Security Manager para administrar Cisco ASA con FirePOWER Services ASA 5512-X, 5515-X, 5525-X, 5545-X, 5555-X 
                                    y 5585-X con Security Services Processor SSP-10, SSP-20, SSP-40 y SSP-60. ASDM V 7.3.x está disponible en el 
                                    dispositivo para administrar implementaciones de instancia única de Cisco ASA 5506-X, 5506W-X, 5506H-X, 5508-X 
                                    y 5516-X con FirePOWER Services.</p>
