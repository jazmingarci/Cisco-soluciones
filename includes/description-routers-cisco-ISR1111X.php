    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="title-border">Router de Servicios Integrados de Cisco 1111x</h3>
                <h5>Fiabilidad, Seguridad y Rendimiento</h5>
                <center> <img class="img-responsive" src="images/routers/Cisco Integrated Services Router 1111x.png" alt=""></center>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title"> 
                                <a data-toggle="collapse" data-parent="#accordionA, #accordionB" href="#collapseOne">Cisco 1111x Series ISRs</a> 
                            </h4>
                        </div>
