                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title"> 
                                <a data-toggle="collapse" data-parent="#accordionA, #accordionB" href="#collapseOne">Cisco 1900 Series Integrated Services Routers</a> 
                            </h4>
                        </div>
                    ...
                    <div class="widget widget-tab">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                                ...
                                <br>
                                En general, Cisco 1941 se basa en la mejor oferta de su clase de los enrutadores de servicios integrados Cisco 1841 existentes al ofrecer 2 modelos: Cisco 1941 y Cisco 1941W. Además de la compatibilidad con una amplia gama de opciones de conectividad inalámbrica y por cable admitidas en la serie Cisco 1941, Cisco 1941W ofrece la integración del punto de acceso IEEE 802.11n que es compatible con los puntos de acceso IEEE 802.11a/b/g.
                                <br>
                                Todos los routers de servicios integrados de la serie 1900 de Cisco ofrecen aceleración de cifrado de hardware incorporado, firewall opcional, prevención de intrusiones y servicios de aplicaciones. Además, las plataformas admiten la gama más amplia de opciones de conectividad por cable e inalámbrica de la industria, como T1/E1, xDSL, 3G y GE.
                                </p>
                            </div>
                            ...
                            <div class="tab-pane" id="tab4">
                                ...
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                                    ...
                                    <td>
                                        <ul class="listas">
                                            <li>Una sola ranura ISM brinda flexibilidad para integrar módulos de servicios inteligentes que no requieren puertos de interfaz.</li>
                                            <li>ISM reemplaza la ranura del módulo de integración avanzada (AIM), los módulos AIM existentes no son compatibles con la ranura ISM</li>
                                            <li>Cada ranura ISM ofrece una alta capacidad de rendimiento de datos</li>
                                            <li>Agregado de hasta 4 Gbps hacia el procesador del enrutador</li>
                                            <li>Hasta 2 Gbps agregados a otras ranuras de módulos a través de MultiGigabit Fabric (MGF)</li>
                                            <li>Las ranuras Power to ISM se pueden administrar mediante extensiones similares al marco Cisco EnergyWise, lo que permite a las organizaciones reducir el consumo de energía en su infraestructura de red. El soporte completo de EnergyWise estará disponible en futuras versiones de software.</li>
                                        </ul>
                                        Nota: Cisco 1941 no puede tener ISM y WLAN en el mismo chasis. Consulte la información de pedido de SKU de WLAN.
                                    </td>
                                    </tr>
                                    <tr>                                        
                                ...
                                <p><strong>LAN inalámbrico</strong>
                                    <br>
                                    Los routers de servicios integrados de Cisco que admiten la red inalámbrica unificada de Cisco permiten la implementación de WLAN seguras y administrables optimizadas para sitios remotos y sucursales, incluida la movilidad rápida y segura, la autenticación de supervivencia y la administración simplificada. La red inalámbrica unificada de Cisco aborda los puntos críticos de posibles fallas y ayuda a habilitar la resiliencia y la capacidad de supervivencia de las WLAN en ubicaciones remotas y sucursales. Esta solución protege la WLAN proporcionando una recuperación rápida de una variedad de fallas que pueden ocurrir. Con la alta disponibilidad de Cisco para WLAN remotas, el hardware y el software trabajan juntos para permitir una rápida recuperación de las interrupciones y ayudar a garantizar la transparencia de fallas para los usuarios y las aplicaciones de red.
                                    <br>
                                ...
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                                    ...
                                    <tr>                                        
                                        ...
                                        <td>Los routers de servicios integrados de la serie Cisco 1900 también son compatibles con SNMP, monitoreo remoto (RMON), syslog, NetFlow y TR-069, además de las funciones de administración integradas mencionadas anteriormente.</td>
                                    </tr>
                                </table>
                                <br>
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                            ...
                            <div class="tab-pane" id="tab2">
                                ...
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                                    ...
                                    <tr>
                                        <td>Ranuras EHWIC de doble ancho
                                            <br>(el uso de una ranura EHWIC de doble ancho consumirá dos ranuras EHWIC)</td>
                                        <td>1</td>
                                    </tr>
                                    <tr>
                                        <td>Ranuras ISM</td>
                                    ...
                                    <tr>
                                        <td>Memoria (Código de corrección de errores DDR2 [ECC] ECC DRAM)
                                            <br>Predeterminada</td>
                                        <td>512 megabytes</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Montaje en pared
                                            <br>(consulte la guía de instalación para conocer la orientación aprobada)</td>
                                        <td>sí</td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="tab-pane" id="tab3">
                                ...
                                Descargue la <a href="datasheets/1900-ISR.pdf" target="_blank">
                                    hoja de datos de los Routers de Servicios Integrados de la serie Cisco 1900</a> (.PDF)
