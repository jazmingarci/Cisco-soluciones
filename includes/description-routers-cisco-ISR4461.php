<section id="main-container">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="title-border">Router Cisco ISR 4431</h3>
                <h5>Router de Servicios de Integrados de la serie ISR 4000</h5>
                <center> <img class="img-responsive" src="images/routers/Cisco Integrated Services Router 4461.png" alt=""></center>
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Cisco ISR 4461 with 4 onboard GE, 3 NIM slots, 1 ISC slot, 3 SM slots, 8 GB Flash Memory default, 2 GB DRAM default (data plane), 4 GB DRAM default (control plane)</strong></p>
                                </div>

                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#ISR4461/K9<br>
                                        <strong>Precio: $32,924.38</strong></p>
                                </div>
                            </div>
                        </div>
                    </div><!--/ Panel 1 end-->
    ...
    <!--                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>3,5 x 17,25 x 18,5 pulgadas 88,9 x 438,15 x 469,9 mm)</td>
                                    </tr>
                                    <tr>
