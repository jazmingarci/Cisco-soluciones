    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="title-border">Cisco Business CBS250-24P-4X  </h3>
                <h5>Switch inteligente PoE + Gigabit Ethernet de 24 puertos con 4 x 10 Gigabit SFP + (presupuesto de energía de 195 W)</h5>
                <center> <img class="img-responsive" src="images/switches/cat-s250-24px.png" alt=""></center>
		              	...
		              	<div class="panel panel-default">
			                ...
			                <div id="collapseOne" class="panel-collapse collapse in">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    ...
                                    <p align='justify'><strong>Cisco Business CBS250-24P-4X 24-Port PoE + Gigabit Ethernet Smart Switch with 4 x 10 Gigabit SFP + (195W Power Budget)</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#CBS250-24P-4X-NA <br>
                                        <strong>Precio: $843.72</strong></p>
                                </div>
			                </div>
                            </div>
		              	</div><!--/ Panel 1 end-->
