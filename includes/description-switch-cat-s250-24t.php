    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="title-border">Cisco Business CBS250-24T-4G</h3>
                <h5>Switch inteligente Gigabit Ethernet de 24 puertos con 4 Gigabit SFP </h5>
                <center> <img class="img-responsive" src="images/switches/cat-s250-24t.png" alt=""></center>
		              	...
		              	<div class="panel panel-default">
			                ...
			                <div id="collapseOne" class="panel-collapse collapse in">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    ...
                                    <p align='justify'><strong>Cisco Business CBS250-24T-4G 24-Port Gigabit Ethernet Smart Switch with 4 x Gigabit SFP</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#CBS250-24T-4G-NA<br>
                                        <strong>Precio: $336.08</strong></p>
                                </div>
			                </div>
                            </div>
		              	</div><!--/ Panel 1 end-->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab2">
                                ...
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                                        <tr>
                                            <th colspan="2" style="text-align: center">CBS250-24T-4G </th>
                                        </tr>
                                        <tr>
