    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="title-border">Cisco SG250-26</h3>
                <h5>Switch inteligente Gigabit de 26 puertos</h5>
                <center> <img class="img-responsive" src="images/switches/cat-s250-26p.png" alt=""></center>
		              	...
		              	<div class="panel panel-default">
			                ...
			                <div id="collapseOne" class="panel-collapse collapse in">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    ...
                                    <p align='justify'><strong>SG250-26 26-port Gigabit Swtch</strong></p>
                                    <p align='justify'>Cisco SG250-26 26-port Gigabit Switch</p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#SG250-26-K9-NA<br>
                                        <strong>Precio: $631.79</strong></p>
                                </div>
			                </div>
                            </div>
		              	</div><!--/ Panel 1 end-->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab2">
                                ...
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                                        <tr>
                                            <th colspan="2" style="text-align: center">CE 250-26</th>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>	440 x 44 x 202 mm (17,3 x 1,45 x 7,95 pulgadas)</td>
                                        </tr>
                                        <tr>
                                            <td>Unidad de peso </td>
                                            <td>2,72 kg (6,0 lb)</td>
                                        </tr>
                                        <tr>
                                            <td>Poder </td>
