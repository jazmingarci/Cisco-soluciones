    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="title-border">Cisco SF250-48HP</h3>
                <h5>48-Port 10/100 PoE+ Smart Switch with 195W Power Budget</h5>
		              	...
		              	<div class="panel panel-default">
			                ...
			                <div id="collapseOne" class="panel-collapse collapse in">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    ...
                                    <p align='justify'><strong>Cisco SF250-48HP 48-Port 10/100 PoE+ Smart Switch with 195W Power Budget</strong></p>
                                    <p align='justify'>48 10/100 PoE+ ports with 195W power budget, 2 Gigabit copper/SFP combo + 2 SFP ports</p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#SF250-48HP-K9-NA<br>
                                        <strong>Precio: $1,273.40</strong></p>
                                </div>
			                </div>
                            </div>
		              	</div><!--/ Panel 1 end-->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab2">
                                ...
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                                        <tr>
                                            <th colspan="2" style="text-align: center">SF250-48HP </th>
                                        </tr>
                                        <tr>
