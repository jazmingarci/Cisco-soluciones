    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="title-border">Cisco Business CBS250-48P-4X  </h3>
                <h5>Switch inteligente PoE + Gigabit Ethernet de 48 puertos con 4 x 10 Gigabit SFP + (presupuesto de energía de 195 W) </h5>
                <center> <img class="img-responsive" src="images/switches/cat-s250-48px.png" alt=""></center>
		              	...
		              	<div class="panel panel-default">
			                ...
			                <div id="collapseOne" class="panel-collapse collapse in">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    ...
                                    <p align='justify'><strong>Cisco Business CBS250-48P-4X 48-Port Gigabit Ethernet PoE + Smart Switch with 4 x 10 Gigabit SFP + (195W Power Budget)</strong></p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#CBS250-48P-4X-NA<br>
                                        <strong>Precio: $1,336.01</strong></p>
                                </div>
			                </div>
                            </div>
		              	</div><!--/ Panel 1 end-->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab2">
                                ...
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                                        <tr>
                                            <th colspan="2" style="text-align: center">CBS250-48P-4X </th>
                                        </tr>
                                        <tr>
