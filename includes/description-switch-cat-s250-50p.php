    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="title-border">Cisco SG250-50P</h3>
                <h5>50-Port PoE+ Gigabit Smart Switch</h5>
                <center> <img class="img-responsive" src="images/switches/cat-s250-50p.png" alt=""></center>
		              	...
		              	<div class="panel panel-default">
			                ...
			                <div id="collapseOne" class="panel-collapse collapse in">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    ...
                                    <p align='justify'><strong>SG250-50P 50-Port PoE+ Gigabit Smart Switch</strong></p>
                                    <!--<p align='justify'>SG250-50 50-Port Gigabit Smart</p>-->
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#SG250-50P-K9-NA<br>
                                        <strong>Precio: $2,107.69</strong></p>
                                </div>
			                </div>
                            </div>
		              	</div><!--/ Panel 1 end-->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab2">
                                ...
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                                        <tr>
                                            <th colspan="2" style="text-align: center">SG250-50P</th>
                                        </tr>
                                        <tr>
