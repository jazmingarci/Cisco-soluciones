		              	...
		              	<div class="panel panel-default">
			                ...
			                <div id="collapseOne" class="panel-collapse collapse in">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-9 col-xs-9">
                                    ...
                                    <p align='justify'><strong>SG250-08 8-Port Gigabit</strong></p>
                                    <p align='justify'>SG250-08 8-Port Gigabit Smart</p>
                                	</div>

                                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#SG250-08-K9-NA<br>
                                        <strong>Precio: $191.41</strong></p>
                                </div>
			                </div>
                            </div>
		              	</div><!--/ Panel 1 end-->
                    ...
                    <div class="widget widget-tab">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                                ...
                                <p align="justify">Para las empresas que requieren alto rendimiento, seguridad avanzada y una gran capacidad de administración de la red, los 
                                    conmutadores completamente administrados son una excelente opción. Sin embargo, también suelen tener etiquetas de precio elevado. Los 
                                    conmutadores inteligentes brindan el nivel adecuado de funciones y capacidades de red para empresas en crecimiento a un precio más bajo, 
                                    por lo que tendrá más dólares para invertir en otras áreas de su negocio. </p>
                            ...
                            <div class="tab-pane" id="tab2">
                                ...
                                <table class="tabla" border="1" cellspacing="5" cellpadding="5" width=100%>
                                        <tr>
                                            <th colspan="2" style="text-align: center">SG250-08 </th>
                                        </tr>
                                        <tr>
